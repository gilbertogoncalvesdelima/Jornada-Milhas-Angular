...
// Modulo raiz
@NgModule({
  // Dentro de declarations, você tem todos os componentes que formam um modulo, dentro do array você irá informar os componentes e as diretivas e pipes que o modulo contém
  declarations: [
    AppComponent,
  ...
  imports: [
    //Dentro de imports, irá adicionar todos os modulos, que o seu modulo precisa para funcionar
    BrowserModule,
    AppRoutingModule,
  ...
  providers: [{
    // Aqui ira declarar todos os serviços, que o modulo está utilizando
